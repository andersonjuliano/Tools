...
#End Region
    ...
    Private Sub CriaCBR()
        ...
        For Each pasta As String In Directory.GetDirectories(CurDir)
            ...
            Catch ex As Exception
                Add("Erro ao criar o arquivo cbz da pasta: " & pasta)
                Add(ex.ToString)
            Finally
            End Try
        Next
        For Each arquivo As String In Directory.GetFiles(CurDir)
            ...
            Try
                ...
                If arquivo.Substring(arquivo.LastIndexOf(".") + 1).ToUpper = "ZIP" Then
                    My.Computer.FileSystem.RenameFile(arquivo, arquivo.Substring(0, arquivo.LastIndexOf(".")) & ".cbz")
                ElseIf arquivo.Substring(arquivo.LastIndexOf(".") + 1).ToUpper = "RAR" Then
                    My.Computer.FileSystem.RenameFile(arquivo, arquivo.Substring(0, arquivo.LastIndexOf(".")) & ".cbr")
                End If
            Catch ex As Exception
                Add("Erro ao renomear o arquivo: " & zip)
                Add(ex.ToString)
            Finally
            End Try
        Next
    ...
    Private Sub Extrai()
        ...
        For Each arquivo As String In Directory.GetFiles(CurDir)
            ...
            Catch ex As Exception
                Add("Erro ao extrair o arquivo: " & zip)
                Add(ex.ToString)
                erros += 1
            Finally
            End Try
    ...
    Private Sub Compacta()
        For Each pasta As String In Directory.GetDirectories(CurDir)
            ...
            Try
                ...
                'End Using
            Catch ex As Exception
                Add("Erro ao criar o arquivo cbr da pasta: " & pasta)
                Add(ex.ToString)
            Finally
            End Try
        Next
    ...
    Private Sub Renomeia(ByVal Diretorio As String)
        ...
        If ckbArquivo.Checked Then
            ...
            If ckbMidia.Checked And Not ckbNumerados.Checked Then
                Dim vnome As String = ""
    ...
    Private Sub Filmes(ByRef vnew As String)
        If ckbFilmes.Checked Then
            ...
            vnew = vnew.Replace(" 1930 ", " (1930) ")
            vnew = vnew.Replace(" 1931 ", " (1931) ")
            vnew = vnew.Replace(" 1932 ", " (1932) ")
            vnew = vnew.Replace(" 1933 ", " (1933) ")
            vnew = vnew.Replace(" 1934 ", " (1934) ")
            vnew = vnew.Replace(" 1935 ", " (1935) ")
            vnew = vnew.Replace(" 1936 ", " (1936) ")
            vnew = vnew.Replace(" 1937 ", " (1937) ")
            vnew = vnew.Replace(" 1938 ", " (1938) ")
            vnew = vnew.Replace(" 1939 ", " (1939) ")
            vnew = vnew.Replace(" 1940 ", " (1940) ")
            vnew = vnew.Replace(" 1941 ", " (1941) ")
            vnew = vnew.Replace(" 1942 ", " (1942) ")
            vnew = vnew.Replace(" 1943 ", " (1943) ")
            vnew = vnew.Replace(" 1944 ", " (1944) ")
            vnew = vnew.Replace(" 1945 ", " (1945) ")
            vnew = vnew.Replace(" 1946 ", " (1946) ")
            vnew = vnew.Replace(" 1947 ", " (1947) ")
            vnew = vnew.Replace(" 1948 ", " (1948) ")
            vnew = vnew.Replace(" 1949 ", " (1949) ")
            vnew = vnew.Replace(" 1950 ", " (1950) ")
            vnew = vnew.Replace(" 1951 ", " (1951) ")
            vnew = vnew.Replace(" 1952 ", " (1952) ")
            vnew = vnew.Replace(" 1953 ", " (1953) ")
            vnew = vnew.Replace(" 1954 ", " (1954) ")
            vnew = vnew.Replace(" 1955 ", " (1955) ")
            vnew = vnew.Replace(" 1956 ", " (1956) ")
            vnew = vnew.Replace(" 1957 ", " (1957) ")
            vnew = vnew.Replace(" 1958 ", " (1958) ")
            vnew = vnew.Replace(" 1959 ", " (1959) ")
            vnew = vnew.Replace(" 1960 ", " (1960) ")
            vnew = vnew.Replace(" 1961 ", " (1961) ")
            vnew = vnew.Replace(" 1962 ", " (1962) ")
            vnew = vnew.Replace(" 1963 ", " (1963) ")
            vnew = vnew.Replace(" 1964 ", " (1964) ")
            vnew = vnew.Replace(" 1965 ", " (1965) ")
            vnew = vnew.Replace(" 1966 ", " (1966) ")
            vnew = vnew.Replace(" 1967 ", " (1967) ")
            vnew = vnew.Replace(" 1968 ", " (1968) ")
            vnew = vnew.Replace(" 1969 ", " (1969) ")
            vnew = vnew.Replace(" 1970 ", " (1970) ")
            vnew = vnew.Replace(" 1971 ", " (1971) ")
            vnew = vnew.Replace(" 1972 ", " (1972) ")
            vnew = vnew.Replace(" 1973 ", " (1973) ")
            vnew = vnew.Replace(" 1974 ", " (1974) ")
            vnew = vnew.Replace(" 1975 ", " (1975) ")
            vnew = vnew.Replace(" 1976 ", " (1976) ")
            vnew = vnew.Replace(" 1977 ", " (1977) ")
            vnew = vnew.Replace(" 1978 ", " (1978) ")
            vnew = vnew.Replace(" 1979 ", " (1979) ")
            vnew = vnew.Replace(" 1980 ", " (1980) ")
            vnew = vnew.Replace(" 1981 ", " (1981) ")
            vnew = vnew.Replace(" 1982 ", " (1982) ")
            vnew = vnew.Replace(" 1983 ", " (1983) ")
            vnew = vnew.Replace(" 1984 ", " (1984) ")
            vnew = vnew.Replace(" 1985 ", " (1985) ")
            vnew = vnew.Replace(" 1986 ", " (1986) ")
            vnew = vnew.Replace(" 1987 ", " (1987) ")
            vnew = vnew.Replace(" 1988 ", " (1988) ")
            vnew = vnew.Replace(" 1989 ", " (1989) ")
            vnew = vnew.Replace(" 1990 ", " (1990) ")
            vnew = vnew.Replace(" 1991 ", " (1991) ")
            vnew = vnew.Replace(" 1992 ", " (1992) ")
            vnew = vnew.Replace(" 1993 ", " (1993) ")
            vnew = vnew.Replace(" 1994 ", " (1994) ")
            vnew = vnew.Replace(" 1995 ", " (1995) ")
            vnew = vnew.Replace(" 1996 ", " (1996) ")
            vnew = vnew.Replace(" 1997 ", " (1997) ")
            vnew = vnew.Replace(" 1998 ", " (1998) ")
            vnew = vnew.Replace(" 1999 ", " (1999) ")
            vnew = vnew.Replace(" 2000 ", " (2000) ")
            vnew = vnew.Replace(" 2001 ", " (2001) ")
            vnew = vnew.Replace(" 2002 ", " (2002) ")
            vnew = vnew.Replace(" 2003 ", " (2003) ")
            vnew = vnew.Replace(" 2004 ", " (2004) ")
            vnew = vnew.Replace(" 2005 ", " (2005) ")
            vnew = vnew.Replace(" 2006 ", " (2006) ")
            vnew = vnew.Replace(" 2007 ", " (2007) ")
            vnew = vnew.Replace(" 2008 ", " (2008) ")
            vnew = vnew.Replace(" 2009 ", " (2009) ")
            vnew = vnew.Replace(" 2010 ", " (2010) ")
            vnew = vnew.Replace(" 2011 ", " (2011) ")
            vnew = vnew.Replace(" 2012 ", " (2012) ")
            vnew = vnew.Replace(" 2013 ", " (2013) ")
            vnew = vnew.Replace(" 2014 ", " (2014) ")
            vnew = vnew.Replace(" 2015 ", " (2015) ")
            vnew = vnew.Replace(" 2016 ", " (2016) ")
            vnew = vnew.Replace(" 2017 ", " (2017) ")
            vnew = vnew.Replace(" 2018 ", " (2018) ")
            vnew = vnew.Replace(" 2019 ", " (2019) ")
    ...
    Private Sub btnLegenda_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLegenda.Click
        ...
        For Each legenda As String In OpenFileDialog1.FileNames
            ...
            Catch ex As Exception
                Add("Não foi possivel corrigir a legenda: " & legenda)
            End Try
    ...
    Private Sub RenomeiaFotos()
        ...
        For Each arq As String In Directory.GetFiles(CurDir)
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Add(old & vextensao & " não é um arquivo de imagem")
            End Try
        Next
